...
<button type="button" class="btn text-light bg-dark btn-sm " data-toggle="modal" data-target="#exampleModalLong">
    <span class=" mx-2">Write for us</span>
</button>
            ...
            <div class="modal-body">
                ...
                <div class="jumbotron bg-dark">
                  ...
                  <div class="alert " role="alert">
                    <span class="h5 text-light text-capitalize  pb-2">
                        Kasatintin is the fastest growing digital news media in Ghana and Africa.
                        <br>
                        You can be part of our creative team as a
                        <br>
                        <b>contributor</b> or a <b> volunteer writer</b> <span>Reporter</span>
