<div class="row">
    <div class=" bg-dark">
        <div class="card-body bg-dark">
            ...
            <div class="mx-3 w-100">@include('model.post.image-carousel')</div>
            @include('model.post.video-carousel')


            <p class="card-text">{{ $post->content }}</p>
            @include('inline')
            <div class="pt-5 pb-3 mx-5">
                ...
                <form class=" input-group-sm" method="POST" action="/subscribe">
                    @csrf
                            ...
                            <input class="form-control  " type="email" placeholder="eg. ewave80@gmail.com"
                            name="email" required>
        ...
        @foreach ($post->comments as $item)
            ...
            <div class=" bg-dark py-0 w-lg-75 ml-lg-5 ml-md-5 ml-sm-0 mx-sm-0">
                <div class=" bg-dark ">
                    <div class="card-body">
                        <h5 class="card-title ml-lg-3 ml-md-3 ml-sm-0"> <img src="{{ $item->author->avatar }}"
                                alt="user_avatr" class="rounded user_avatr mr-2">
